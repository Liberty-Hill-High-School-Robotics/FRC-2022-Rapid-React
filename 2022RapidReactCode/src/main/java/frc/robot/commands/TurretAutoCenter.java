 ...
 *
 */
public class TurretAutoCenter extends PIDCommand {


    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTOR


    public TurretAutoCenter(Turret subsystem) {
...
*/
        //MADE BY THE PID WIZZZARD 
        super(new PIDController(0.15, 0.0, 0.0),  subsystem::getPIDCommand_Input, 0 , output -> subsystem.setThisPID(output));
