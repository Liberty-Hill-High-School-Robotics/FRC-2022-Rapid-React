...
private Encoder shaftEncoderRight;
...
shaftEncoderRight = new Encoder(0, 1, false, EncodingType.k4X);
 addChild("shaftEncoderRight",shaftEncoderRight);
 shaftEncoderRight.setDistancePerPulse(1.0);
