...
private final Joystick driverJoystick = new Joystick(0);
  ...
  */
  private RobotContainer() {
    ...
    SmartDashboard.putData("BeltToFull", new BeltToFull());
    SmartDashboard.putData("IntakeToFull", new IntakeToFull());
...
intakeInButton.whileHeld(new IntakeToFull() ,true);
    SmartDashboard.putData("intakeInButton",new IntakeToFull() );
...
beltUpButton.whileHeld(new BeltToFull() ,true);
    SmartDashboard.putData("beltUpButton",new BeltToFull() );
